...
flowchart LR
  ...
  pkg_crew["crew"]
  svc_crew["ctx.crew<br/>Workspace-scoped crew roster, ticket ledger, and message pool"]
  pkg_tool_crew_director["tool-crew-director"]
  pkg_tool_crew_member["tool-crew-member"]
  pkg_tool_crew_review["tool-crew-review"]
  pkg_e2b["e2b"]
  ...
  svc_crew --> pkg_tool_crew_director
  svc_crew --> pkg_tool_crew_member
  svc_crew --> pkg_tool_crew_review
...
| `ctx.crew` | `core` | [`crew`](../packages/crew/crew) | - | [`tool-crew-director`](../packages/crew/tool-crew-director), [`tool-crew-member`](../packages/crew/tool-crew-member), [`tool-crew-review`](../packages/crew/tool-crew-review) | - | One process-wide domain over ctx.storage.domain; every roster/ticket/message record is self-scoped by an explicit workspaceId, the same per-record scoping dsh-workspace uses for its own records. |
