...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/crew/crew': { kind: 'indirect', reason: 'The domain service registers no prompt, schema, or tool; dsh-tool-crew-director, dsh-tool-crew-member, and dsh-tool-crew-review own every model-facing surface over it.' },
